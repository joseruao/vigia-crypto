...
try:
    ...
    # Carrega sempre para garantir que está atualizado
    ...
    for env_path in env_paths:
        if env_path.exists():
            load_dotenv(env_path, override=True)  # override=True para garantir
            break
except ImportError:
...
# Lê as variáveis DEPOIS de tentar carregar o .env
